...
\texttt{lmcut()} grows by a factor of 508 over the same step, and it is the optimal configuration that scales furthest.
...
\question{Your own Assessment 3 domain, and the last question before Thursday's deadline.
