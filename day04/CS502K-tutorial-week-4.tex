...
\textbf{Before this session, install a planner.}
Follow the local planner setup guide released alongside this tutorial.
...
Then, if you have VAL built, check yourself against it:}
