...
\answer{
\begin{enumerate}
\item The mathematical objection (from G\"odel) and the argument from consciousness survive largely intact, because neither turns on how good the machine gets.
...
out to find out how human cognition actually works. 
...
In studying perception, we tend to focus on sensors such as cameras that extract useful information from the actual world. (In a world without light, cameras would not be much use.) 
...
\item 
%% SOURCE: AIMA 3e Ex 1.11, verbatim, with AIMA's answer.
...
``I have no evidence of a pit here'' and ``I can prove there is no pit here'' say different things, and only the second justifies the move.
\end{enumerate}
}
